...
public class AttributeTransferHandler extends TransferHandler {
	...
	public boolean importData(TransferHandler.TransferSupport support) {
        ...
        try {
            ...
            Attribute a =  ((Attribute)listModel.get(0)).getParentConfig().getMart()
            	.getMasterConfig().getAttributeByName(attName, new ArrayList<String>());
	...
	public Transferable createTransferable(JComponent c) {
		...
		if(c instanceof JList){
			selValue = ((Attribute)((JList) c).getSelectedValue()).getName();
