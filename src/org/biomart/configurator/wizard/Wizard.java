...
import org.biomart.configurator.view.component.JStatusBar;
...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    ...
    static String BACK_TEXT = Resources.get("BACK");
    static String NEXT_TEXT = Resources.get("NEXT");
    static String FINISH_TEXT = Resources.get("FINISH");
    static String CANCEL_TEXT = Resources.get("CANCEL");   
     ...
     */    
    public void setCurrentPanel(Object id, boolean next) {
        ...
        WizardPanel currentPanel = wizardModel.getCurrentPanel();
        currentPanel.aboutToDisplayPanel(next);
        
        wizardModel.setNextButtonEnabled((!currentPanel.isFinalPanel()) && currentPanel.validateWizard());
        this.setFinishButtonEnabled(currentPanel.isFinalPanel() && currentPanel.validateWizard());
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (evt.getPropertyName().equals(WizardModel.CURRENT_PANEL_DESCRIPTOR_PROPERTY)) {
            wizardController.resetBackButtonToPanelRules(); 
    ...
    void close(int code) {
        returnCode = code;
        McEventBus.getInstance().removeListener(McEventProperty.STATUSBAR_SHOW.toString(), this.sbar);
        McEventBus.getInstance().removeListener(McEventProperty.STATUSBAR_UPDATE.toString(), this.sbar);
    ...
    private void initComponents() {
        ...
        finishButton = new JButton(Wizard.FINISH_TEXT);
        
        backButton.setActionCommand(BACK_BUTTON_ACTION_COMMAND);
        nextButton.setActionCommand(NEXT_BUTTON_ACTION_COMMAND);
        cancelButton.setActionCommand(CANCEL_BUTTON_ACTION_COMMAND);
        finishButton.setActionCommand(Wizard.FINISH_BUTTON_ACTION_COMMAND);
        ...
        secondaryComponents.add(new JProgressBar() );

        buttonPanel.add(buttonBox, java.awt.BorderLayout.EAST);
        JPanel statusPanel = new JPanel(new BorderLayout());
        statusPanel.add(buttonPanel,BorderLayout.CENTER);
        this.sbar = new JStatusBar();
        statusPanel.add(sbar,BorderLayout.SOUTH);
        
        McEventBus.getInstance().addListener(McEventProperty.STATUSBAR_SHOW.toString(), this.sbar);
        McEventBus.getInstance().addListener(McEventProperty.STATUSBAR_UPDATE.toString(), this.sbar);
        
        wizardDialog.getContentPane().add(statusPanel, java.awt.BorderLayout.SOUTH);
   ...
   /**
    ...
    public void updateButtonEnabled() {
    	WizardPanel currentPanel = this.wizardModel.getCurrentPanel();
    	boolean validated = currentPanel.validateWizard();
    	this.nextButton.setEnabled(validated && (!currentPanel.isFinalPanel()));
    	this.finishButton.setEnabled(validated && currentPanel.isFinalPanel()); 
