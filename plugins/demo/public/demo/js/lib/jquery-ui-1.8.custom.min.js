...
$.widget("ui.selectable", $.ui.mouse, {
	...
	_create: function() {
        ...
        this.beginIndex = this.selectees.filter('.ui-selected').eq(0).index();
        
        if (isNaN(this.beginIndex)) {
            this.beginIndex = 0;
        }
	...
	_mouseStop: function(event) {
        ...
        if (!this.dragged) {
            if (event.shiftKey) {
                var i, j;
                if (this.beginIndex < this.currentIndex) {
                    i = this.beginIndex;
                    j = this.currentIndex;
                } else {
                    i = this.currentIndex;
                ...
                this.selectees.slice(i, j).addClass('ui-selecting');
            } else {
