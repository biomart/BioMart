...
!function(t){"use strict";var e=t.module("martVisualEnrichment.controllers");e.controller("VisualizationCtrl",["$scope","queryBuilder","bmservice","progressState",function(t,e,s,a){var r=this,n=e.build().then(function(t){return s.query(t,{cache:!1,headers:{Accept:"application/json,text/plain"}}).then(function(t){var e=t.data.graphs;if(e)return Object.keys(e).map(function(t){var s=e[t];return{title:t,nodes:s.nodes,edges:s.edges}});throw new Error(t.data)})});t.mvTabs=[],t.progressbarValue=33,r.state=a,r.state.setState(r.state.states.GETTING_DATA),n.then(function(e){t.mvTabs=e,r.state.setState(r.state.states.PROCESSING)},function(e){t.errorMessage=e.status||e.message,t.progressbarValue=100,r.state.setState(r.state.states.ERROR)})}])}(angular);
...
!function(e,t){"use strict";function n(e){e=t.select(e);var n=e.select("svg").node().parentNode.innerHTML;if(o){var r="data:image/svg+xml;base64,"+btoa(n);window.open(r,"_blank")}else{var a=new Blob([n],{type:"data:image/svg+xml;charset=base64"});saveAs(a,"enrichment-network.svg")}}function r(e){var t=JSON.stringify(e);if(o){var n="data:application/json;charset=utf-8,"+t;window.open(n,"_blank")}else{var r=new Blob([t],{type:"data:application/json;charset=utf-8"});saveAs(r,"enrichment-network.json")}}function a(e){for(var t={},n=0,r=e.edges.length;r>n;++n){var a=e.edges[n];(t[a.target.id]||(t[a.target.id]=[])).push(a.source.id)}var i="",s="	";for(var c in t){var l=e.nodes.filter(function(e){return e.id===c}),u=l[0];i+=[c,u.description,t[c].join(","),u.pvalue].join(s)+"\n"}if(o){var d="data:text/plain;charset=utf-8,"+i;window.open(d,"_blank")}else{var f=new Blob([i],{type:"data:text/plain;charset=utf-8"});saveAs(f,"enrichment-network.tsv")}}function i(e){e=t.select(e);var n=(t.select("body").append("canvas").attr("id","canvas").style("display","none"),e.select("svg").node().parentNode.innerHTML);canvg("canvas",n);var r=document.getElementById("canvas");if(o){var a=r.toDataURL("image/jpeg",1);window.open(a,"download")}else r.toBlob(function(e){saveAs(e,"enrichment-network.jpeg")},"image/jpeg",1);t.select("#canvas").remove()}var o=-1!=navigator.userAgent.indexOf("Safari")&&-1==navigator.userAgent.indexOf("Chrome"),s=function(e){return function(t,n,r){function a(e){return k(e.id)}function i(e){e.selected=!1}function o(e){e.selected=!0}function s(e){return"term"===e.type}function c(e){return parseFloat(e.pvalue)}function l(){I.attr("transform","translate("+e.event.translate+")scale("+e.event.scale+")")}function u(){function t(t){t.px=t.x,t.py=t.y,t.x+=e.event.dx,t.y+=e.event.dy}function n(e){if(e.selected){var n=J.filter(function(e){return e.selected});n.each(t)}else t(e);y()}var r=e.behavior.drag().origin(function(e){return e}).on("drag.graph",n);this.on(".drag",null),this.call(r)}function d(e,t){return p(e,t)}function f(e,t){for(var n=0,r=t.length;r>n;++n)h(e,t[n])}function h(e,t){for(var n,r,a=t.source,i=t.target,o=0,s=e.length;s>o&&("string"==typeof a||"string"==typeof i);)n=e[o],r=n.id,a===r?t.source=a=n:i===r&&(t.target=i=n),++o}function p(e,t){for(var n,r,a,i=[],o=!1,s=0,c=0,l=e.length;l>c;++c){n=e[c];for(var u=0+s,d=t.length;d>u;++u)r=t[u],r.target===n?(o=!0,-1===i.indexOf(r.source)&&i.push(r.source)):r.source===n&&(o=!0,-1===i.indexOf(r.target)&&i.push(r.target)),o&&(o=!1,a=t[s],t[s]=r,t[u]=a,++s)}return[i,s>0?t.slice(0,s):[]]}function v(e){var t=z[1]-z[0];return e.r=e.pr=0===t?13:13*(1-(parseFloat(e.pvalue)-z[0])/(z[1]-z[0]))+10}function g(e,t){var n=e.length,r=360/n*Math.PI/180,a=r,i=t.centre||[0,0],o=t.radius||50,s=t.offset||20;e.forEach(function(e){e.x=i[0]+o*Math.cos(a)+(-s+2*Math.random()*s),e.y=i[1]+o*Math.sin(a)+(-s+2*Math.random()*s),a+=r})}function m(e){var t=10,n=e.r+t,r=e.x-n,a=e.x+n,i=e.y-n,o=e.y+n;return function(n,s,c,l,u){if(n.point&&n.point!==e){var d=e.x-n.point.x,f=e.y-n.point.y,h=Math.sqrt(d*d+f*f),p=e.r+n.point.r+t;p>h&&(h=(h-p)/h*.5,e.x-=d*=h,e.y-=f*=h,n.point.x+=d,n.point.y+=f)}return s>a||r>l||c>o||i>u}}function y(t){J.each(function(n){e.select(this).attr({cx:function(){return t&&(n.x="term"===n.type?n.x+1.71*(N/2-n.x)*t.alpha:Math.max(n.r,Math.min(N-n.r,n.x))),n.x},cy:function(){return t&&(n.y="term"===n.type?n.y+1.71*(O/2-n.y)*t.alpha:Math.max(n.r,Math.min(O-n.r,n.y))),n.y}})}),C.attr({x1:function(e){return e.source.x},y1:function(e){return e.source.y},x2:function(e){return e.target.x},y2:function(e){return e.target.y}}),W.attr("transform",function(e){return"translate("+e.x+","+e.y+")"})}function x(n){for(var r=e.geom.quadtree(t),a=0,i=t.length;++a<i;)r.visit(m(t[a]));n.alpha<.0075&&!Q&&(I.style("visibility",null),Q=!0),y(n)}function w(t){if(t.pr===t.r){var n=e.select(this);n.transition().attr("r",t.r=1.5*t.r),n.classed("node-selected",!0)}}function b(t){var n=e.select(this);e.select(this).transition().attr("r",t.r=t.pr),n.classed("node-selected",!1)}function k(e){return"e"+e.replace(/[:;,\.]*/g,"")}function A(e){var r,a,i,o=$||($=[]),s=q||(q=[]);if(!o.length){for(r=t.length,a=n.length,o=new Array(r),i=0;r>i;++i)o[i]=[],s[i]=[];for(i=0;a>i;++i){var c=n[i];o[c.source.index].push(c.target),o[c.target.index].push(c.source),s[c.source.index].push(c),s[c.target.index].push(c)}}return o[e]}function j(e){var t=A(e),n=q;return t.concat(n[e])}r=r||{};var E=e.select(r.container),M=r.showNth||5,_=r.margin||{top:20,right:30,bottom:20,left:30},N=(r.width||1200)-_.right-_.left,O=(r.height||800)-_.top-_.bottom,$=[],q=[];f(t,n);var S=t.filter(s).splice(0,M),z=e.extent(S,c),B=d(S,n),D=B[0];n=B[1];var P=Object.keys(D[0]),F=Object.keys(S[0]).filter(function(e){return"$"!==e[0]&&"_"!==e[0]});B=null;var H=e.behavior.zoom().scaleExtent([0,4]).on("zoom",l),L=E.append("svg:svg").attr({title:"test2",version:1.1,xmlns:"http://www.w3.org/2000/svg",width:N+_.right+_.left,height:O+_.top+_.bottom}).style("cursor","pointer");L.append("rect").attr("width","100%").attr("height","100%").style("fill","#fff"),L=L.append("svg:g").attr("transform",["translate(",_.left,",",_.top,")"].join("")).call(H).on("mousedown.zoom",null);var T=(L.append("rect").attr("width",N).attr("height",O).style("fill","white").style("pointer-events","all"),e.tip().attr("class","d3-tip").offset([-10,0]).html(function(e){var t="gene"===e.type?P:F;return t.reduce(function(t,n){return t+'<strong class="d3-tip-prop">'+n+"</strong>: "+e[n]+"<br/>"},"")})),I=L.append("svg:g").attr("class","enrichment-vis").style("visibility","hidden"),R=v({pvalue:z[0]});g(S,{centre:[N/2,O/2],radius:5,offset:5}),g(D,{centre:[N/2,O/2],radius:5*R,offset:5});var U=e.layout.force().size([N,O]).linkDistance(3*R).nodes(S.concat(D)).links(n).gravity(.5).charge(function(e){return"gene"===e.type?-400:-150*e.weight}).on("tick",x).start().alpha(.0087);t=U.nodes();var C=I.selectAll(".line").data(n).enter().append("line").attr("class","line").style({stroke:"#556270","shape-rendering":"geometricPrecision"}).attr("id",function(e,t){return e.index=t,"link"+t}),G=e.scale.category20();I.selectAll(".term").data(S).enter().append("circle").attr("r",v).attr("id",a).classed({term:!0,node:!0}).style({opacity:.9,fill:function(e){return G(e.pvalue)},stroke:"#333","stroke-width":2}),I.selectAll(".gene").data(D).enter().append("circle").attr("r",function(e){return e.r=e.pr=8}).attr("id",a).classed({gene:!0,node:!0}).style({opacity:.9,fill:"#D7D2AE",stroke:"#F28882","stroke-width":2}).call(T);var J=I.selectAll(".node");J.call(u).on("mouseover.node.tip",T.show).on("mouseout.node.tip",T.hide).on("mouseover.node.transition",w).on("mouseout.node.transition",b).on("click.hightlightneighbors",function(e,r){var a=j(r).concat([e]);t.forEach(i),n.forEach(i),a.forEach(o),J.classed("selected",function(e){return e.selected}),C.classed("selected",function(e){return e.selected})});{var K=e.svg.brush().x(e.scale.identity().domain([0,N])).y(e.scale.identity().domain([0,O])).on("brushend",function(){e.event.target.clear(),e.select(this).call(e.event.target)}).on("brush.clear",function(){C.classed("selected",i)}).on("brush",function(){function t(e){return e.selected=n[0][0]<=e.x&&e.x<n[1][0]&&n[0][1]<=e.y&&e.y<n[1][1]}var n=e.event.target.extent();J.classed("selected",t)});L.insert("g",".enrichment-vis").attr("class","brush").call(K)}L.select(".brush .background").style("fill","white");var V=I.append("svg:g").attr("class","node-text");V.selectAll(".term-label").data(S).enter().append("svg:g").append("svg:text").attr("class","term-label").style({"text-anchor":"middle","shape-rendering":"crispEdges"}).text(function(e){return e.description.length>28?e.description.substr(0,25)+"...":e.description}),V.selectAll(".gene-label").data(D).enter().append("svg:g").append("svg:text").attr("class","gene-label").style({"text-anchor":"middle","shape-rendering":"crispEdges","font-size":"0.7em"}).text(function(e){return e.id});var W=V.selectAll("g"),Q=!1;return{hn:[],remove:function(){I.remove(),E.select("svg").remove()},highlightNode:function(e){var t=document.querySelector("#"+k(e));t&&(w.call(t,t.__data__),this.hn.push(t))},restoreNodes:function(){this.hn.forEach(function(e){b.call(e,e.__data__)}),this.hn=[]}}}}.call(this,t);e.module("martVisualEnrichment.directives").directive("mvGraph",["$rootScope","progressState","$timeout",function(t,o,c){function l(e,l){var u=null;c(function(){var o=l.find("div").eq(0);u=s(e.nodes,e.edges,{container:o[0],width:l.width(),height:l.height()}),l.find(".save-jpeg").on("click",function(){i(l.find("div").eq(0)[0])}),l.find(".save-svg").on("click",function(){n(l.find("div").eq(0)[0])}),l.find(".save-json").on("click",function(){r({nodes:e.nodes,edges:e.edges})}),l.find(".save-tsv").on("click",function(){a({nodes:e.nodes,edges:e.edges})});var c=t.$on("term.mouseover",function(e,t){u.highlightNode(t.id)}),d=t.$on("term.mouseout",function(e,t){u.restoreNodes(t.id)});e.$on("$destroy",function(){u.remove(),c(),d()})},200),o.setState(o.states.NETWORK);var d=!0;e.$watch(function(e){return e.filterPattern},function(e,t){d&&(d=!1)})}return{restrict:"E",replace:!0,templateUrl:"mart-visual-enrichment/app/partials/vis.html",scope:{nodes:"=nodes",edges:"=edges",filterPattern:"="},compile:function(t){var n=e.element(window).prop("innerHeight");return t.css("height",n+"px"),l}}}])}(angular,d3);
